...
MODEL_REGISTRY = {
    "car_parts": {
        ...
        "models": [
            ...
            {
                "id": "parts-sam-mobile",
                "name": "MobileSAM promptable pieces",
                "provider": "Hugging Face / Kornia",
                "architecture": "MobileSAM",
                "source_url": "https://huggingface.co/kornia/mobile_sam",
                "dataset": "SA-1B distillation, prompted with vehicle-part regions",
                "license": "Apache-2.0",
                "status": "poids publics, segmentation promptable",
                "device_preference": "cuda:0 -> cpu",
                "classes": CAR_PART_CLASSES,
            },
        ],
    ...
    "damage": {
        ...
        "models": [
            ...
            },
            {
                ...
                "name": "MobileSAM promptable dommages",
                "provider": "Hugging Face / Kornia",
                "architecture": "MobileSAM",
                "source_url": "https://huggingface.co/kornia/mobile_sam",
                "dataset": "SA-1B distillation, prompted with damage candidate regions",
                "license": "Apache-2.0",
                "status": "poids publics, segmentation promptable",
                "device_preference": "cuda:0 -> cpu",
                "classes": DAMAGE_CLASSES_EXTENDED,
